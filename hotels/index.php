...
$destination = trim($_GET['destination'] ?? 'Bali');
...
");
$count_stmt->execute(["%$destination%"]);
...
if (!empty($hotels)) {
    ...
    // Hasilnya: [hotel_id => facilities_string]
...
<header class="bg-surface border-b border-outline-variant shadow-sm top-0 z-50 sticky">
    <div class="flex justify-between items-center w-full px-gutter max-w-container-max mx-auto h-20">
        ...
        <nav class="hidden md:flex items-center gap-xl">
            <a class="text-primary font-bold border-b-2 border-primary pb-1" href="#">Hotels</a>
            ...
            <a class="text-on-surface-variant font-medium hover:text-primary transition-colors" href="#">My Bookings</a>
        </nav>
        ...
        <form method="GET" action="">
            <div class="flex flex-col md:flex-row gap-md items-center bg-surface-container-lowest p-sm rounded-xl border border-outline-variant shadow-sm">
                ...
                <div class="flex-1 flex items-center gap-sm px-md border-r border-outline-variant/30">
                    ...
                    <div class="flex flex-col">
                        <!-- ✅ FIX: Label diperbaiki dari "Destinasi" jadi "Tanggal" -->
                        <span class="text-label-sm font-label-sm text-on-surface-variant">Tanggal</span>
                        <input class="bg-transparent border-none p-0 text-body-md focus:ring-0 w-full"
                               placeholder="When?" type="text" value="10-15 Oct">
                    </div>
                </div>
                ...
                <div class="flex-1 flex items-center gap-sm px-md">
                    ...
                    <div class="flex flex-col">
                        <span class="text-label-sm font-label-sm text-on-surface-variant">Guests</span>
                        <input class="bg-transparent border-none p-0 text-body-md focus:ring-0 w-full"
                               placeholder="How many?" type="text" value="2 Adults, 1 Room">
                    </div>
                </div>
    ...
    <aside class="w-full md:w-72 flex-shrink-0 space-y-xl">
        <div class="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant shadow-sm">
            ...
            <div class="mb-xl">
                ...
                <input class="w-full h-2 bg-surface-variant rounded-full appearance-none cursor-pointer accent-primary"
                       max="5000000" min="0" step="100000" type="range">
                <div class="flex justify-between mt-sm">
                    <span class="text-label-sm text-on-surface-variant">Rp 0</span>
                    <span class="text-label-sm text-on-surface-variant">Rp 5.000.000+</span>
                </div>
            </div>
            ...
            <div class="mb-xl">
                ...
                <div class="space-y-sm">
                    <label class="flex items-center gap-sm cursor-pointer">
                        ...
                        <div class="flex text-secondary-container"><?= renderStars(5) ?></div>
                    </label>
                    <label class="flex items-center gap-sm cursor-pointer">
                        <input class="w-5 h-5 rounded border-outline text-primary focus:ring-primary" type="checkbox">
                        <div class="flex text-secondary-container"><?= renderStars(4) ?></div>
                    </label>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-sm">
                    ...
                    foreach ($filter_facilities as [$icon, $label]):
                    ?>
        ...
        <div class="bg-primary-container p-lg rounded-xl text-on-primary-container relative overflow-hidden group">
            <div class="relative z-10">
                ...
                <p class="text-body-md opacity-90 mb-md">
                    Join TravelEase Rewards today for exclusive member prices.
                </p>
